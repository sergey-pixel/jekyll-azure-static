...
Используя приведенные ниже инструкции и интерактивные примеры кода, вы можете делать запросы API за считаные минуты.  
Если у вас уже есть учетная запись и вы хотели бы пропустить подробную документацию, сразу перейдите к [Руководству по быстрому старту](https://weatherstack.com/quickstart).  
